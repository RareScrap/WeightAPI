 ...
 */
@Mod(modid = ExampleMod2.MODID, version = ExampleMod2.VERSION, dependencies = "required-after:configurableweight@[0.5.0]")
public class ExampleMod2 {
    public static final String MODID = "weightapi_example2";
